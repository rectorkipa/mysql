...
INSERT INTO users VALUES (1, 'Petya', 'Petukhov','99999999929', 'petya@mail.com', '81dc9bdb52d04dc20036dbd8313ed055', DEFAULT, DEFAULT); 

INSERT INTO users VALUES (2, 'Vasya', 'Vasilkov','99999999920', 'vasya@mail.com', '81dc9bdb52d04dc20036dbd8313ed055', DEFAULT, DEFAULT);

INSERT INTO users VALUES (3, 'Olga', 'Olgova','99988877766', 'olga@mail.com', '81dc9bdsfsfsdfdb52d04dc20036dbd8313ed055', DEFAULT, DEFAULT);

INSERT INTO users VALUES (4, 'Irina', 'Irinenko','99988877765', 'irina@mail.com', '52d04dc20036dbd8313ed055', DEFAULT, DEFAULT);

INSERT INTO users VALUES (5, 'Nikolay', 'Nikolaev','99988877764', 'nikolay@mail.com', '232381dc9bdsfsfsdfdb52d04dc20036dbd8313ed055', DEFAULT, DEFAULT);

INSERT INTO users VALUES (6, 'Anatoliy', 'Zakharchenko','99988877763', 'anatoliy@mail.com', '81dc9bdsfsfsdfdb52d04dc', DEFAULT, DEFAULT);

INSERT INTO users VALUES (7, 'Alina', 'Alinina','99988877762', 'alina@mail.com', '81dssssssc9bdsfsfsdfdb52d04dc', DEFAULT, DEFAULT);

INSERT INTO users VALUES (8, 'Petr', 'Petchenko','99988877761', 'petr@mail.com', '81dc9bdsfsfsdfdbssssqw52d04dc', DEFAULT, DEFAULT);

INSERT INTO users VALUES (9, 'Vasiliy', 'Vasin','99988877760', 'vasiliy@mail.com', '81dc9bdsf444sfsdfdb52d04dc', DEFAULT, DEFAULT);

INSERT INTO users VALUES (10, 'Angelina', 'Angelinina','99988877759', 'angelina@mail.com', 'd04dc', DEFAULT, DEFAULT);
...
-- профиль Васи и остальных
INSERT INTO profiles VALUES (2, 'm', '1988-11-02', 2, 'Moscow', 'Russia');

INSERT INTO profiles VALUES (3, 'f', '2003-11-03', 3, 'Piter', 'Russia');

INSERT INTO profiles VALUES (4, 'f', '2004-10-04', 1, 'Samara', 'Russia');

INSERT INTO profiles VALUES (5, 'm', '1970-12-05', 2, 'Tula', 'Russia');

INSERT INTO profiles VALUES (6, 'm', '1975-01-06', 3, 'Nsk', 'Russia');

INSERT INTO profiles VALUES (7, 'f', '2010-02-07', 1, 'Piter', 'Russia');

INSERT INTO profiles VALUES (8, 'm', '1980-03-08', 2, 'Moscow', 'Russia');

INSERT INTO profiles VALUES (9, 'm', '1984-04-09', 3, 'Kaluga', 'Russia');

INSERT INTO profiles VALUES (10, 'f', '2014-07-28', 15, 'New York', 'USA');
...
INSERT INTO messages VALUES (DEFAULT, 1, 3, 'Ti kto?', DEFAULT, DEFAULT, DEFAULT);

INSERT INTO messages VALUES (DEFAULT, 3, 1, 'A ti kto?', DEFAULT, DEFAULT, DEFAULT);

INSERT INTO messages VALUES (DEFAULT, 4, 5, 'Nikolay, tam na rabote zaval', DEFAULT, DEFAULT, DEFAULT);

INSERT INTO messages VALUES (DEFAULT, 5, 4, 'Ya pereuchivayus, chobi zavershit etot proekt', DEFAULT, DEFAULT, DEFAULT);

INSERT INTO messages VALUES (DEFAULT, 9, 10, 'Ti takaya umnichka', DEFAULT, DEFAULT, DEFAULT);

INSERT INTO messages VALUES (DEFAULT, 10, 9, 'Sam takoy!', DEFAULT, DEFAULT, DEFAULT);
...
INSERT INTO friend_requests VALUES (3, 4, 0);

INSERT INTO friend_requests VALUES (5, 6, 1);

INSERT INTO friend_requests VALUES (7, 8, 0);

INSERT INTO friend_requests VALUES (9, 10, 1);

INSERT INTO friend_requests VALUES (1, 10, 0);

INSERT INTO friend_requests VALUES (9, 8, 1);

INSERT INTO friend_requests VALUES (6, 7, 0);

INSERT INTO friend_requests VALUES (3, 5, 1);

INSERT INTO friend_requests VALUES (2, 9, 0);

INSERT INTO friend_requests VALUES (2, 10, 1);
...
INSERT INTO communities VALUES (DEFAULT, 'Number2', 'I am number 2', 2);

INSERT INTO communities VALUES (DEFAULT, 'Number3', 'I am number 3', 3);

INSERT INTO communities VALUES (DEFAULT, 'Number4', 'I am number 4', 4);

INSERT INTO communities VALUES (DEFAULT, 'Number5', 'I am number 5', 5);

INSERT INTO communities VALUES (DEFAULT, 'Number6', 'I am number 6', 6);

INSERT INTO communities VALUES (DEFAULT, 'Number7', 'I am number 7', 7);

INSERT INTO communities VALUES (DEFAULT, 'Number8', 'I am number 8', 8);

INSERT INTO communities VALUES (DEFAULT, 'Number9', 'I am number 9', 9);

INSERT INTO communities VALUES (DEFAULT, 'Number10', 'I am number 10', 10);
...
INSERT INTO communities_users VALUES (3, 3);

INSERT INTO communities_users VALUES (4, 4);

INSERT INTO communities_users VALUES (5, 5);

INSERT INTO communities_users VALUES (6, 6);

INSERT INTO communities_users VALUES (7, 7);

INSERT INTO communities_users VALUES (8, 8);

INSERT INTO communities_users VALUES (9, 9);

INSERT INTO communities_users VALUES (10, 10);

INSERT INTO communities_users VALUES (10, 1);
...
INSERT INTO media_types VALUES (DEFAULT, 'видео 18+');

INSERT INTO media_types VALUES (DEFAULT, 'изображение 18+');

INSERT INTO media_types VALUES (DEFAULT, 'музыка 18+');

INSERT INTO media_types VALUES (DEFAULT, 'документ 18+');

INSERT INTO media_types VALUES (DEFAULT, 'QR');

INSERT INTO media_types VALUES (DEFAULT, 'QR 18+');
...
INSERT INTO media VALUES (DEFAULT, 3, 2, 'song.mp3', 100, DEFAULT);

INSERT INTO media VALUES (DEFAULT, 4, 4, 'movie.mov', 78, DEFAULT);

INSERT INTO media VALUES (DEFAULT, 5, 5, 'xxx.mp4', 1024, DEFAULT);

INSERT INTO media VALUES (DEFAULT, 6, 6, 'xxx.jpg', 100, DEFAULT);

INSERT INTO media VALUES (DEFAULT, 7, 7, 'xxx.wav', 78, DEFAULT);

INSERT INTO media VALUES (DEFAULT, 8, 8, 'xxx.doc', 1024, DEFAULT);

INSERT INTO media VALUES (DEFAULT, 9, 9, 'qr.psd', 100, DEFAULT);
...
INSERT INTO money_transfer VALUES (DEFAULT, 2, 3, 1820, 'USD', DEFAULT, DEFAULT, DEFAULT);

INSERT INTO money_transfer VALUES (DEFAULT, 3, 4, 18200, 'RUB', DEFAULT, DEFAULT, DEFAULT);

INSERT INTO money_transfer VALUES (DEFAULT, 4, 5, 182000, 'EUR', DEFAULT, DEFAULT, DEFAULT);

INSERT INTO money_transfer VALUES (DEFAULT, 5, 6, 1820000, 'USD', DEFAULT, DEFAULT, DEFAULT);

INSERT INTO money_transfer VALUES (DEFAULT, 6, 7, 18200000, 'RUB', DEFAULT, DEFAULT, DEFAULT);

INSERT INTO money_transfer VALUES (DEFAULT, 7, 8, 182000000, 'EUR', DEFAULT, DEFAULT, DEFAULT);

INSERT INTO money_transfer VALUES (DEFAULT, 8, 9, 18, 'USD', DEFAULT, DEFAULT, DEFAULT);

INSERT INTO money_transfer VALUES (DEFAULT, 9, 10, 180, 'RUB', DEFAULT, DEFAULT, DEFAULT);

INSERT INTO money_transfer VALUES (DEFAULT, 10, 1, 1800, 'USD', DEFAULT, DEFAULT, DEFAULT);
...
INSERT INTO wall_text VALUES (DEFAULT, 1, 2, 'Already.', DEFAULT, DEFAULT);

INSERT INTO wall_text VALUES (DEFAULT, 3, 4, 'Happy birthday!', DEFAULT, DEFAULT);

INSERT INTO wall_text VALUES (DEFAULT, 4, 3, 'THANX!', DEFAULT, DEFAULT);

INSERT INTO wall_text VALUES (DEFAULT, 5, 6, 'Let us go for a walk!', DEFAULT, DEFAULT);

INSERT INTO wall_text VALUES (DEFAULT, 6, 5, 'OK!', DEFAULT, DEFAULT);

INSERT INTO wall_text VALUES (DEFAULT, 7, 8, 'How are you!', DEFAULT, DEFAULT);

INSERT INTO wall_text VALUES (DEFAULT, 8, 7, 'Fine!', DEFAULT, DEFAULT);

INSERT INTO wall_text VALUES (DEFAULT, 9, 10, 'My congrats!', DEFAULT, DEFAULT);

INSERT INTO wall_text VALUES (DEFAULT, 10, 9, 'Thank you!', DEFAULT, DEFAULT);
...
INSERT INTO liked VALUES (DEFAULT, 2, 1, 1, DEFAULT);

INSERT INTO liked VALUES (DEFAULT, 1, 2, DEFAULT, DEFAULT);

INSERT INTO liked VALUES (DEFAULT, 3, 4, DEFAULT, DEFAULT);

INSERT INTO liked VALUES (DEFAULT, 4, 3, DEFAULT, DEFAULT);

INSERT INTO liked VALUES (DEFAULT, 5, 6, DEFAULT, DEFAULT);

INSERT INTO liked VALUES (DEFAULT, 6, 5, DEFAULT, DEFAULT);

INSERT INTO liked VALUES (DEFAULT, 7, 8, DEFAULT, DEFAULT);

INSERT INTO liked VALUES (DEFAULT, 8, 7, DEFAULT, DEFAULT);

INSERT INTO liked VALUES (DEFAULT, 9, 10, DEFAULT, DEFAULT);

INSERT INTO liked VALUES (DEFAULT, 10, 9, DEFAULT, DEFAULT);

SELECT * FROM liked;

-- ДР 4 
-- i. Заполнить все таблицы БД vk данными (по 10-20 записей в каждой таблице) - заполнение таблиц выше.
...
UPDATE messages SET created_at = '2024-03-18 10:00:00' WHERE id = 10; 
...
DROP TABLE IF EXISTS wall_text;
...
CREATE TABLE users(
  ...
  name VARCHAR(182),
  birthday_at DATE,
  created_at VARCHAR(182),
  updated_at VARCHAR(182)
);

INSERT INTO users (name, birthday_at, created_at, updated_at) VALUES
('Олег', '1992-09-03', '07.01.2019 13:10', '07.01.2019 13:10'),
('Ксения', '1986-12-04', '20.05.2018 17:35', '20.05.2018 17:35'),
('Игорь', '1990-01-22', '14.08.2019 20:05', '14.08.2019 20:05'),
('Артем', '1998-06-13', '21.10.2017 10:20', '21.10.2017 10:20'),
('Алина', '1986-07-04', '12.01.2017 8:35', '12.01.2017 8:35')
;
...
ALTER TABLE users CHANGE updated_at uodated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
